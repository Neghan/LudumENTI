...
public class OrgulloMovement : MonoBehaviour
{
    //Grid
    [Range(0, 8)]
    public int rows;
    ...
    GameObject GO, GO2, GO3, GO4, GO5, GO6, GO7;
    ...
    Vector3Int Upx3Cell; // Arribax3
    Vector3Int Upx3LeftCell; // Arribax3-Izquierda
    Vector3Int Upx3RightCell; // Arribax3-Derecha
    ///Ataque derecha
    ...
    Vector3Int Rightx3Cell; // Derechax3
    Vector3Int Rightx3DownCell; // Derechax3-Abajo 
    Vector3Int Rightx3UpCell; // Derechax3-Arriba 
    ///Ataque Abajo
    ...
    Vector3Int Downx3Cell; //Abajox
    Vector3Int Downx3LeftCell; //Abajox3-Izquierda
    Vector3Int Downx3RightCell; //Abajox3-Derecha
    ///Ataque Izquierda
    ...
    Vector3Int Leftx3Cell; //Izquierdax3
    Vector3Int Leftx3DownCell; //Izquierdax3 Abajo
    Vector3Int Leftx3UpCell; //Izquierdax3 Arriba
    ...
    private Vector3Int WhereIsPlayer()
    {
        ...
        Leftx3Cell = new Vector3Int(currentCell.x - 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y, currentCell.z); //Izquierdax2
        Leftx3UpCell = new Vector3Int(currentCell.x - 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y + Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); //Izquierdax2Arr
        Leftx3DownCell = new Vector3Int(currentCell.x - 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y - Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); //Izquierdax2Abj
        ///Ataque Abajo
        ...
        Downx3Cell = new Vector3Int(currentCell.x, currentCell.y - 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); //Abajox2
        Downx3LeftCell = new Vector3Int(currentCell.x - Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y - 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); //Abajox2-Izquierda
        Downx3RightCell = new Vector3Int(currentCell.x + Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y - 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); //Abajox2-Derecha
        ///Ataque derecha
        ...
        Rightx3Cell = new Vector3Int(currentCell.x + 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y, currentCell.z); // Derechax2
        Rightx3DownCell = new Vector3Int(currentCell.x + 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y - Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); // Derecha-Abajo 
        Rightx3UpCell = new Vector3Int(currentCell.x + 3 * Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y + Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); // Derecha-Abajo 
        ///Ataque Abajo
        ...
        Upx3Cell = new Vector3Int(currentCell.x, currentCell.y + 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); // Arribax2
        Upx3LeftCell = new Vector3Int(currentCell.x - Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y + 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); // Arribax2-Izquierda
        Upx3RightCell = new Vector3Int(currentCell.x + Vector3Int.CeilToInt(myGrid.cellSize).x, currentCell.y + 3 * Vector3Int.CeilToInt(myGrid.cellSize).y, currentCell.z); // Arribax2-Derecha
        ...
        if (Attacking)
        {
            if (AlreadyWarning && !AlreadyAttack && !showWarning)
            {
                ...
                if (currentCell.x > playerPos.x)
                {
                    ...
                    GO5 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Leftx3Cell), transform.rotation);
                    GO6 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Leftx3DownCell), transform.rotation);
                    GO7 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Leftx3UpCell), transform.rotation);
                }
                //Jugador a la derecha
                else if (currentCell.x < playerPos.x)
                {
                    ...
                    GO5 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Rightx3Cell), transform.rotation);
                    GO6 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Rightx3DownCell), transform.rotation);
                    GO7 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Rightx3UpCell), transform.rotation);
                ...
                else if (currentCell.y > playerPos.y)
                {
                    ...
                    GO5 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Downx3Cell), transform.rotation);
                    GO6 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Downx3LeftCell), transform.rotation);
                    GO7 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Downx3RightCell), transform.rotation);
                }
                //Jugador arriba
                else if (currentCell.y < playerPos.y)
                {
                    ...
                    GO5 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Upx3Cell), transform.rotation);
                    GO6 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Upx3LeftCell), transform.rotation);
                    GO7 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(Upx3RightCell), transform.rotation);
                }
            ...
            else if (AlreadyAttack)
            {
                ...
                if (PlayerP == Dir.Iz)
                {
                    ...
                    GO5 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Leftx3Cell), transform.rotation);
                    GO6 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Leftx3DownCell), transform.rotation);
                    GO7 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Leftx3UpCell), transform.rotation);
                }
                //Jugador a la derecha
                else if (PlayerP == Dir.Der)
                {
                    ...
                    GO5 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Rightx3Cell), transform.rotation);
                    GO6 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Rightx3DownCell), transform.rotation);
                    GO7 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Rightx3UpCell), transform.rotation);
                ...
                else if (PlayerP == Dir.Abj)
                {
                    ...
                    GO5 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Downx3Cell), transform.rotation);
                    GO6 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Downx3LeftCell), transform.rotation);
                    GO7 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Downx3RightCell), transform.rotation);
                }
                //Jugador arriba
                else if (PlayerP == Dir.Arr)
                {
                    ...
                    GO5 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Upx3Cell), transform.rotation);
                    GO6 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Upx3LeftCell), transform.rotation);
                    GO7 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(Upx3RightCell), transform.rotation);
                }
