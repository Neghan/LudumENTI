...
public class GulaMovement : MonoBehaviour
{
    //Grid
    [Range(0, 8)]
    public int rows;
        ...
        if (Attacking)
        {
            if (AlreadyWarning && !AlreadyAttack && !showWarning)
            {
                ...
                if (currentCell.x > playerPos.x)
                {
                    ...
                    GO3 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(DownCell), transform.rotation);
                ...
                else if (currentCell.y > playerPos.y)
                {
                    ...
                    GO2 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(RightCell), transform.rotation);
                    GO3 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(LeftCell), transform.rotation);
                ...
                else if (currentCell.y < playerPos.y)
                {
                    ...
                    GO2 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(LeftCell), transform.rotation);
                    GO3 = Instantiate(warningEnemy, myGrid.GetCellCenterWorld(RightCell), transform.rotation);
            ...
            else if (AlreadyAttack)
            {
                ...
                if (PlayerP == Dir.Iz)
                {
                    ...
                    GO3 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(DownCell), transform.rotation);
                ...
                else if (PlayerP == Dir.Abj)
                {
                    ...
                    GO2 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(RightCell), transform.rotation);
                    GO3 = Instantiate(attackEnemy, myGrid.GetCellCenterWorld(LeftCell), transform.rotation);
